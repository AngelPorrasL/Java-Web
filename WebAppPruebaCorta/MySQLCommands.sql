...
select * from productos where Name like '%coca%col%'

delete from productos where Id = 3 and Name = 'Coca-Cola'

update productos set Name = 'Pineapple' where Id = 2 and Name = 'Watermelon'