...
public class loadProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("        <a class=\"btn btn-info\" href=\"productsServlet\">Go back</a>");
            out.println("    </div>");
            out.println("    <div class='card-body'>");
            out.println("        <form action='updateProductsServlet' method='post'>");
            ...
            out.println("                        <label for='txtId'>Idn</label>");
            out.println("                    </div>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Name") + "' name='txtName' type='text' class='form-control' id='txtName' placeholder='Tomatoes' required>");
            out.println("                        <label for='txtName'>Name</label>");
            out.println("                    </div>        ");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Category") + "' name='txtCategory' type='text' class='form-control' id='txtCategory' placeholder='Vegetables' required>");
            out.println("                        <label for='txtCategory'>Category</label>");
            out.println("                    </div> ");
            out.println("                </div>");
            out.println("                <div class='col'>");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getInt("Price") + "' name='txtPrice' type='number' class='form-control' id='txtPrice' placeholder='395' required>");
            out.println("                        <label for='txtPrice'>Price</label>");
            out.println("                    </div>  ");
            out.println("                    <div class='form-floating mb-3'>");
            out.println("                        <input value='" + resultSet.getString("Fecha") + "' name='txtFecha' type='text' class='form-control' id='txtFecha' placeholder='10/20/2022' required>");
            out.println("                        <label for='txtFecha'>Fecha</label>");
            out.println("                    </div>  ");
            out.println("                </div>");
            out.println("            </div>");
            out.println("            <hr>");
            out.println("            <button type='submit' class='btn btn-primary' style='float: right;margin-left:3px'>Update</button>");   
            out.println("               <a class=\"btn btn-danger\" style='float: right' href='deleteProductsServlet?Id=" + resultSet.getInt("Id") + "'>Delete</a>");
            out.println("        </form>");
            out.println("    </div>");
            out.println("</div>");
            out.println("</div>");
